 ...
 * given. A test that wrote a real `~/Library/LaunchAgents/io.github.youndie.kachok.plist` would
...
class AutostartTest {
    ...
    fun macOsWritesALaunchAgentThatNamesTheLauncherAndTheFlag() {
        val plist = root.resolve("Library/LaunchAgents/io.github.youndie.kachok.plist")
    ...
    fun macOsRemovesTheLaunchAgentAgain() {
        ...
        assertTrue(!Files.exists(root.resolve("Library/LaunchAgents/io.github.youndie.kachok.plist")))
        assertTrue(!mac().isEnabled())
    }
