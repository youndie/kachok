...
- Anchors: `ui/src/commonMain/kotlin/io/github/youndie/kachok/ui/main/MainWindow.kt`,
  `ui/src/commonMain/kotlin/io/github/youndie/kachok/ui/list/NarrowTable.kt` (which is what
  `TorrentTable.kt` became).
