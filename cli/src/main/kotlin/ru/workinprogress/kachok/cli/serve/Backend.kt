...
import ru.workinprogress.kachok.wire.FileState
import ru.workinprogress.kachok.wire.PeerState
import ru.workinprogress.kachok.wire.Reply
import ru.workinprogress.kachok.wire.Request
import ru.workinprogress.kachok.wire.Snapshot
import ru.workinprogress.kachok.wire.TorrentState
import ru.workinprogress.kachok.wire.TrackerState
...
internal class Backend(
    ...
    private suspend fun add(
        ...
        name: String,
        directory: String?,
        parse: () -> ru.workinprogress.kachok.engine.metainfo.Metainfo,
    ) {
        val metainfo =
            try {
                parse()
